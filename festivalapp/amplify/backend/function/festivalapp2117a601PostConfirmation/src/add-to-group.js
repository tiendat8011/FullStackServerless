...
exports.handler = async (event, context, callback) => {
  ...
  const adminEmails = ['ntd8011@gmail.com']
// If the user is one of the admins, set the isAdminvariable to true
  if
...
// First check to see if the groups exists, and if notcreate the group
    try {
